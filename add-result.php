...
$mark=$_POST['marks'];
 ...
 $stmt = $dbh->prepare("SELECT subjects.SubjectName,subjects.id FROM subjectgroup join  subjects on  subjects.id=subjectgroup.SubjectId WHERE subjectgroup.ClassId=:cid order by subjects.SubjectName");
...
for($i=0;$i<count($mark);$i++){
    ...
    if($mar>100)
    {
        echo "<script>alert('Marks should be less than equal to 100');</script>";
...
<html lang="en">
    <head>
        ...
        <title>Student Result Management System | Add Result </title>
