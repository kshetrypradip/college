...
<html lang="en">
    <head>
        ...
        <title>Student Result Management System | Manage Classes</title>
                                        ...
                                        <div class="panel">
                                            <div class="panel-heading">
                                                <div class="panel-title">
                                                    <h5>View Classes Information</h5>
                                                </div>
                                            </div>
                                            <?php if($msg || $error): ?>
...
<td>
<a href="update-class.php?classid=<?php echo htmlentities($result->id);?>"><i class="fa fa-edit" title="Edit Record"></i> </a> 
