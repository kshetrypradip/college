...
<?php endif; ?>
                                            <div class="panel-body p-20">
                                                ...
                                                <table id="example" class="display table table-striped table-bordered" cellspacing="0" width="100%">
                                                    ...
                                                    <tbody>
<?php $sql = "SELECT  distinct students.StudentName,students.RollId,students.RegDate,students.StudentId,students.Status,classes.ClassName,classes.Section from result join students on students.StudentId=result.StudentId  join classes on classes.id=result.ClassId";
