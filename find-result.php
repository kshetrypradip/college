...
<html lang="en">
    <head>
        ...
        <title>Dept.of ISE Student Result Management System</title>
    ...
    <div class="row">
    <u><h1 align="center">DEPT. OF AIML STUDENT MANAGEMENT SYSTEM</h1></u>
    
    <body class="" style="background-image: url('https://www.rnsit.ac.in/wp-content/themes/twentyseventeen/img/r1.jpg');background-repeat: no-repeat;
                        ...
                        <div class="panel login-box">
                            <div class="panel-heading">
                                <div class="panel-title text-center">
                                    <h4>Result Of Student Management System</h4>
                                </div>
                            </div>
...
<?php }} ?>
                                    ...
                                    <div class="form-group mt-20">
                                        <div class="">
                                        <div class="col-sm-6">
                                                                 <a href="index.php" button type="button" class="btn btn-danger   ">Back to Home?</a>
                                                            </div>
