...
$status=1;
$sql="update subjectgroup set status=:status where id=:acid ";
...
$did=intval($_GET['did']);
$status=0;
$sql="update subjectgroup set status=:status where id=:did ";
$query = $dbh->prepare($sql);
...
<html lang="en">
    <head>
        ...
        <title>Student Result Management System | Manage Subjects Combination</title>
                                        ...
                                        <div class="panel">
                                            <div class="panel-heading">
                                                <div class="panel-title">
                                                    <h5>View Subjects Combination Information</h5>
                                                </div>
                                            </div>
                                            <?php if($msg || $error): ?>
...
<?php endif; ?>
                                            <div class="panel-body p-20">
                                                ...
                                                <table id="example" class="display table table-striped table-bordered" cellspacing="0" width="100%">
                                                    ...
                                                    <tbody>
<?php $sql = "SELECT classes.ClassName,classes.Section,subjects.SubjectName,subjectgroup.id as scid,subjectgroup.status from subjectgroup join classes on classes.id=subjectgroup.ClassId  join subjects on subjects.id=subjectgroup.SubjectId";
$query = $dbh->prepare($sql);
$query->execute();
