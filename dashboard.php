...
<html lang="en">
    ...
    <body class="top-navbar-fixed" style="background-image: url('dashboard.jpg');background-repeat: no-repeat;
                            ...
                            <div class="container-fluid">
                                <div class="row">
                                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                        <a class="dashboard-stat bg-info" href="manage-students.php">
<?php
...
?>
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                        <a class="dashboard-stat bg-info" href="manage-subjects.php">
<?php
...
?>
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                        <a class="dashboard-stat bg-info" href="manage-classes.php">
                                        <?php
